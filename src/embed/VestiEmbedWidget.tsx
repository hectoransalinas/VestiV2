...
const FitOverlay: React.FC<OverlayProps> = ({ fit, viewMode, footLength }) => {
  ...
  return (
    ...
    >
      ...
      {lengthZones.map((lz) => {
        ...
        return (
          <React.Fragment key={lz.zone}>
            {/* Barra vertical tipo "regla" al costado derecho */}
            <div
              style={{
                position: "absolute",
                top: layout.top,
            ...
            {/* Texto compacto al lado de la barra */}
            <div
              style={{
                position: "absolute",
                right: "11%",
      ...
      {hasShoeOverlay && (
        <>
          {/* Halo de color en la zona de las zapatillas */}
          <div
            style={{
              position: "absolute",
              left: "26%",
      ...
      >
        {viewMode === "top" && (
          <>
            ...
            />
            <Field
              label="Largo torso (cm)"
              value={user.largoTorso}
